...
if __name__ == '__main__':
    ...
    opt.parser.set_defaults(dataroot='detect_result', name='formal_author',checkpoints_dir='../checkpoints',lm_dir='landmarks', model='test', dataset_mode='single', norm='batch', which_epoch=300, gpu_ids='-1')
    print(opt.parser.parse_args())
    opt = opt.parse()
    opt.use_local = True
